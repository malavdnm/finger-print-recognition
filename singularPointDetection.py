...
image_names1 = os.listdir('/home/malavdnm/Desktop/DIP/Project/DB1_B')
image_names1.sort()
# image_names2 = os.listdir('/home/malavdnm/Desktop/DIP/Project/DB2_B')
# image_names1.sort()
# image_names3 = os.listdir('/home/malavdnm/Desktop/DIP/Project/DB3_B/')
# image_names4 = os.listdir('/home/malavdnm/Desktop/DIP/Project/DB4_B')
# image_names4.sort()
...
for images in tqdm(image_names1):
	print(images)
	(a, b) = singularPointDetection('/home/malavdnm/Desktop/DIP/Project/DB1_B/' + images)
